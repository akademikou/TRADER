...
//	beep();
	...
	dist_R_EA.param(std::uniform_real_distribution<double>::param_type{-100,100});
	mt_A_EA.seed(static_cast<long unsigned int>(std::chrono::high_resolution_clock::now().time_since_epoch().count())) ;
	/**************************************************************************************/
