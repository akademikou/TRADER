...
protected:
	...
	inline bool COMPARE_UPDATE_B(double* _In1,const double* _In2,const bool UPDATE);
	inline bool COMPARE_UPDATE_W(double* _In1,const double* _In2,const bool UPDATE);
	inline bool NOTIFY(double* _In1,const MY::uint &_id,const MY::uint &_i,const bool verbose);
};
#endif
/**********************************************************************************************/
