...
int    BinaCPP_logger::debug_level   = 0; // 1 olursa herseyi yazıyor
///////////////////////////////////////////////////////////////////////
std::string BinaCPP_logger::debug_log_file = "/tmp/binawatch.log";
...
void BinaCPP_logger::write_log( const char *fmt, ... ) {
    ...
    if ( debug_log_file_enable == 1 ) { open_logfp_if_not_opened(); }
...
//---------------------
void BinaCPP_logger::set_debug_level( int level ) { debug_level = level;}
//--------------------
void BinaCPP_logger::set_debug_logfile(std::string &pDebug_log_file ) {  debug_log_file = pDebug_log_file;}
//--------------------
